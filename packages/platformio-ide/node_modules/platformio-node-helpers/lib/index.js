...
var ensureServerStarted = exports.ensureServerStarted = function () {
  ...
  return function ensureServerStarted() {
    return _ref2.apply(this, arguments);
  };
}();
...
var PlatformIOCoreStage = function (_BaseStage) {
  ...
  _createClass(PlatformIOCoreStage, [{
    ...
    key: 'autorunPIOCmds',
    value: function autorunPIOCmds(cmds, when) {
      if (!cmds) {
        return;
      }
      return Promise.all(cmds.filter(function (cmd) {
        return !cmd.when || cmd.when.includes(when);
      }).map(function (cmd) {
        return new Promise(function (resolve, reject) {
          core.runPIOCommand(cmd.args, function (code, stdout, stderr) {
            if (code !== 0) {
        ...
        return _regenerator2.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 25:
                _context7.next = 27;
                return this.autorunPIOCmds(this.params.autorunPIOCmds, 'post-check');
        ...
        return _regenerator2.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 32:
                _context8.next = 34;
                return this.autorunPIOCmds(this.params.autorunPIOCmds, 'post-install');
