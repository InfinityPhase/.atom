...
var renameLiteral = function renameLiteral(j, preFileDir, nextFileDir) {
  return function (path) {
    ...
    var nextRelativePath = (0, _fileHelpers.ensureDotSlash)((0, _fileHelpers.formatPath)((0, _path.relative)(nextFileDir, absolutePath)));
...
function importRelativeTransform(file, api, options) {
  ...
  var paths = options.paths,
      _options$printOptions = options.printOptions,
      printOptions = _options$printOptions === undefined ? {} : _options$printOptions;
  ...
  var requireDeclarations = root.find(j.CallExpression, {
